...
from myPaper.imagePreprocess_Function import fusion_crack
from myPaper.cal_nearest_point import cal_nearest_points
...
def getImage():
    img_path="D:\carck_detect_system\myPaper\\0-00203.bmp"
    # cv2.namedWindow('res')
