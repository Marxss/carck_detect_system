...
# print(v16.GetOutput())
# print("****************************************************")
# v16=vtkDICOMImageReader()
# v16.SetDirectoryName("D:\BaiduNetdiskDownload\COU IV")
# v16.SetDataByteOrderToLittleEndian()
# print(v16.GetOutput())
reader = vtk.vtkStructuredPointsGeometryFilter()
...
# rayCastFunc=vtk.vtkVolumeRayCastCompositeFunction()


volumeMapper = vtk.vtkFixedPointVolumeRayCastMapper()
volumeMapper.SetInputConnection(v16.GetOutputPort())
volumeMapper.SetBlendModeToComposite()
# volumeMapper.SetVolumeRayCastFunction(rayCastFunc)
...
camera.SetPosition(c[0] + 400, c[1]+400, c[2]+400)
